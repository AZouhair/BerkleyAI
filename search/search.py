...
def uniformCostSearch(problem):
    ...
    fringe.push([[(problem.getStartState(), None, 0)], 0], 0)
    visited = {}
    ...
    while not fringe.isEmpty():
        ...
        if Pos not in visited: 
            visited[Pos]=1
            for successor in problem.getSuccessors(Pos):
                fringe.push([Node + [successor], Cost + successor[2]], Cost + successor[2] + nullHeuristic(successor[0], problem))
    ...
    while fringe:
        ...
        if currentPos not in visited: 
            ...
            for successor in problem.getSuccessors(currentPos):
                fringe.push([currentNode + [successor], currentCost + successor[2]], currentCost + successor[2] + heuristic(successor[0], problem))
